...
export const menuItemsLeft = [
  {
    ...
    items: [
      ...
      {
        title: 'Mocha',
        description: 'A delightful blend of espresso, chocolate, steamed milk, and great amazing whipped cream.',
        price: '72DH'
      },
      {
...
export const menuItemsRight = [
  {
    ...
    items: [
      ...
      {
        title: 'Scone',
        description: 'A slightly sweet or savory biscuit-like pastry, perfect for a quick bite.',
        price: '49DH'
      }
    ]
  },
